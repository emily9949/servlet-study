package com.sumin.section02.delete;
...
public class DeleteSessionDataServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("attribute 무효화 전 fristName : " + session.getAttribute("firstName"));
        System.out.println("attribute 무효화 전 secondName : " + session.getAttribute("secondName"));
        ...
        /* 설명. seesion이 무효화되어 attribute를 가져올 수 없게 된다 (가져오려고 하면 500에러 발생)*/
    }
}
